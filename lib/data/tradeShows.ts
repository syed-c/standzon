...
export const tradeShows: TradeShow[] = [
  // Technology Shows
  {
    ...
    venue: {
      ...
      totalSpace: 500000,
      hallCount: 27,
      facilities: ['Free WiFi', 'Catering', 'Parking', 'Security', 'Translation Services'],
      nearbyHotels: ['Maritim Airport Hotel', 'Leonardo Hotel Hannover', 'Best Western Hannover City'],
    ...
    description: 'The world\'s largest and most international computer and technology fair, showcasing digital innovations across all industries.',
  ...
  },
  {
    ...
    venue: {
      ...
      totalSpace: 306000,
      hallCount: 19,
      facilities: ['Medical-grade facilities', 'Conference rooms', 'Parking', 'Restaurants', 'Security'],
      nearbyHotels: ['Hyatt Regency Düsseldorf', 'Maritim Hotel Düsseldorf', 'Holiday Inn Düsseldorf'],
      transportAccess: ['Düsseldorf Airport', 'S-Bahn', 'U-Bahn'],
      parkingSpaces: 12000,
      cateringOptions: ['Medical dietary options', 'International cuisine', 'Quick service'],
      wifiQuality: 'Excellent',
      loadingBays: 36
    },
    city: 'Düsseldorf',
    ...
    description: 'The world\'s largest medical trade fair, featuring the latest innovations in medical technology, devices, and healthcare solutions.',
    website: 'https://medica.de',
    expectedVisitors: 81000,
    expectedExhibitors: 4500,
    standSpace: 284000,
    ticketPrice: '€65-95',
    organizerName: 'Messe Düsseldorf GmbH',
  ...
  },
  {
    ...
    venue: {
      ...
      totalSpace: 160000,
      hallCount: 26,
      facilities: ['Modern tech infrastructure', 'Conference centers', 'Parking', 'Dining', 'Security'],
      nearbyHotels: ['InterContinental Berlin', 'Pullman Berlin Schweizerhof', 'Hotel Palace Berlin'],
      transportAccess: ['Berlin Brandenburg Airport', 'S-Bahn', 'U-Bahn', 'Bus'],
      parkingSpaces: 8500,
      cateringOptions: ['Tech-friendly venues', 'International food', 'Grab & go options'],
      wifiQuality: 'Excellent',
      loadingBays: 28
    },
    city: 'Berlin',
    ...
    countryCode: 'DE',
    industries: [industries[0]], // Technology
    description: 'One of the oldest industrial exhibitions in Germany and a leading trade show for consumer electronics and home appliances.',
  ...
  },
  {
    ...
    venue: {
      ...
      totalSpace: 280000,
      hallCount: 12,
      facilities: ['State-of-art AV', 'Tech infrastructure', 'Parking', 'Food courts', 'Security'],
      nearbyHotels: ['Westgate Las Vegas', 'Renaissance Las Vegas', 'Hilton Grand Vacations'],
    ...
    countryCode: 'US',
    industries: [industries[0]], // Technology
    description: 'The world\'s most influential technology event, showcasing the latest innovations and trends that will shape the future.',
  ...
  },
  {
    ...
    venue: {
      ...
      totalSpace: 500000,
      hallCount: 27,
      facilities: ['Industrial infrastructure', 'Heavy machinery areas', 'Conference centers', 'Parking'],
      nearbyHotels: ['Maritim Airport Hotel', 'Leonardo Hotel', 'Best Western Hannover'],
      transportAccess: ['Hannover Airport', 'S-Bahn', 'Shuttle services'],
      parkingSpaces: 15000,
      cateringOptions: ['Industrial catering', 'International cuisine', 'Exhibition dining'],
      wifiQuality: 'Excellent',
      loadingBays: 50
    },
    city: 'Hannover',
    ...
    description: 'The world\'s leading trade fair for industrial technology, automation, digitalization, and energy solutions.',
  ...
  },
  {
    ...
    venue: {
      ...
      totalSpace: 200000,
      hallCount: 8,
      facilities: ['5G infrastructure', 'Demo areas', 'Conference halls', 'International pavilions'],
      nearbyHotels: ['Hotel Fira Congress', 'AC Hotel Barcelona Forum', 'Hilton Barcelona'],
      transportAccess: ['Barcelona Airport', 'Metro', 'High-speed rail'],
      parkingSpaces: 14000,
      cateringOptions: ['Mediterranean cuisine', 'International food', 'Networking venues'],
      wifiQuality: 'Excellent',
      loadingBays: 24
    },
    city: 'Barcelona',
    ...
    countryCode: 'ES',
    industries: [industries[0]], // Technology
    description: 'The premier event for the mobile industry, featuring the latest in mobile technology, 5G, IoT, and digital transformation.',
  ...
  // ===================
  {
    ...
    venue: {
      ...
      totalSpace: 306000,
      hallCount: 19,
      facilities: ['Industrial facilities', 'Conference rooms', 'Parking', 'Restaurants', 'Security'],
      nearbyHotels: ['Hyatt Regency Düsseldorf', 'Maritim Hotel Düsseldorf', 'Holiday Inn Düsseldorf'],
      transportAccess: ['Düsseldorf Airport', 'S-Bahn', 'U-Bahn'],
      parkingSpaces: 12000,
      cateringOptions: ['Industrial catering', 'International cuisine', 'Quick service'],
      wifiQuality: 'Excellent',
      loadingBays: 36
    },
    city: 'Düsseldorf',
    ...
    countryCode: 'DE',
    industries: [industries[3]], // Manufacturing
    description: 'The world\'s leading trade fair for plastics and rubber, featuring the latest innovations in materials, processing, and manufacturing.',
...

  {
    ...
    venue: {
      ...
      totalSpace: 578000,
      hallCount: 10,
      facilities: ['Automotive test tracks', 'Conference centers', 'Parking', 'Dining', 'Security'],
      nearbyHotels: ['Kempinski Hotel Gravenbruch', 'Sheraton Frankfurt Airport', 'Hilton Frankfurt'],
      transportAccess: ['Frankfurt Airport', 'S-Bahn', 'U-Bahn', 'Autobahn'],
      parkingSpaces: 18000,
      cateringOptions: ['Automotive-themed dining', 'International food', 'Business lounges'],
      wifiQuality: 'Excellent',
      loadingBays: 45
    },
    city: 'Frankfurt',
    ...
    description: 'The world\'s leading trade fair for the automotive service industry, showcasing parts, systems, and services.',
...

  {
    ...
    venue: {
      ...
      totalSpace: 306000,
      hallCount: 19,
      facilities: ['Food-grade facilities', 'Packaging demo areas', 'Conference rooms', 'Parking'],
      nearbyHotels: ['Hyatt Regency Düsseldorf', 'Maritim Hotel Düsseldorf', 'Holiday Inn Düsseldorf'],
      transportAccess: ['Düsseldorf Airport', 'S-Bahn', 'U-Bahn'],
      parkingSpaces: 12000,
      cateringOptions: ['Food industry catering', 'International cuisine', 'Packaging demos'],
      wifiQuality: 'Excellent',
      loadingBays: 36
    },
    city: 'Düsseldorf',
    ...
    description: 'The world\'s leading trade fair for packaging machinery, packaging materials, and confectionery machinery.',
  ...
  // ===================
  {
    ...
    venue: {
      ...
      totalSpace: 200000,
      hallCount: 12,
      facilities: ['Healthcare-grade infrastructure', 'Conference centers', 'Parking', 'Dining'],
      nearbyHotels: ['Hyatt Regency Grand Cypress', 'Rosen Shingle Creek', 'Hilton Orlando'],
      transportAccess: ['Orlando Airport', 'Shuttle services', 'Rental cars'],
      parkingSpaces: 15000,
      cateringOptions: ['Healthcare-friendly dining', 'International cuisine', 'Conference catering'],
      wifiQuality: 'Excellent',
      loadingBays: 28
    },
    city: 'Orlando',
    ...
    countryCode: 'US',
    industries: [industries[1]], // Healthcare
    description: 'The premier healthcare IT conference and exhibition, showcasing innovations in health information and technology.',
    ...
    costs: {
      ...
      additionalCosts: [
        ...
        { item: 'Regulatory compliance consulting', cost: 800, mandatory: false }
      ]
    }
  },

  {
    ...
    venue: {
      ...
      totalSpace: 240000,
      hallCount: 4,
      facilities: ['Heavy machinery areas', 'Manufacturing demos', 'Conference centers', 'Parking'],
      nearbyHotels: ['Hyatt Regency McCormick Place', 'Hilton Chicago', 'Marriott Chicago'],
      transportAccess: ['Chicago O\'Hare Airport', 'CTA Green Line', 'Shuttle services'],
      parkingSpaces: 8000,
      cateringOptions: ['Industrial catering', 'Chicago cuisine', 'Convention dining'],
      wifiQuality: 'Excellent',
      loadingBays: 35
    },
    city: 'Chicago',
    ...
    countryCode: 'US',
    industries: [industries[3]], // Manufacturing
    description: 'The International Manufacturing Technology Show - the premier manufacturing technology event in the Americas.',
...

  {
    ...
    venue: {
      ...
      totalSpace: 280000,
      hallCount: 12,
      facilities: ['Broadcast facilities', 'Demo theaters', 'Conference rooms', 'Parking'],
      nearbyHotels: ['Westgate Las Vegas', 'Renaissance Las Vegas', 'Hilton Grand Vacations'],
      transportAccess: ['McCarran Airport', 'Monorail', 'Shuttle services'],
      parkingSpaces: 5000,
      cateringOptions: ['Media-friendly venues', 'International food', 'VIP hospitality'],
      wifiQuality: 'Excellent',
      loadingBays: 20
    },
    city: 'Las Vegas',
    ...
    countryCode: 'US',
    industries: [industries[0]], // Technology
    description: 'The world\'s largest convention covering filmed entertainment and the development, management and delivery of content.',
  ...
  // ===================
  {
    ...
    venue: {
      ...
      totalSpace: 240000,
      hallCount: 8,
      facilities: ['Food-grade facilities', 'Tasting areas', 'Conference centers', 'Parking'],
      nearbyHotels: ['Pullman Paris Charles de Gaulle Airport', 'Hyatt House Paris', 'Holiday Inn Paris'],
      transportAccess: ['Charles de Gaulle Airport', 'RER B', 'Shuttle services'],
      parkingSpaces: 14000,
      cateringOptions: ['Gourmet food court', 'International cuisine', 'Wine tasting areas'],
      wifiQuality: 'Excellent',
      loadingBays: 30
    },
    city: 'Paris',
    ...
    countryCode: 'FR',
    industries: [industries[4]], // Food & Beverage
    description: 'The world\'s largest food innovation exhibition, showcasing the latest trends in food and beverage industry.',
...

  {
    ...
    venue: {
      ...
      totalSpace: 216000,
      hallCount: 7,
      facilities: ['Tech infrastructure', 'Startup areas', 'Conference halls', 'Innovation labs'],
      nearbyHotels: ['Pullman Paris Tour Eiffel', 'Novotel Paris Centre', 'Mercure Paris'],
      transportAccess: ['Orly Airport', 'Metro Line 12', 'Bus lines'],
      parkingSpaces: 9000,
      cateringOptions: ['Tech-friendly dining', 'Startup food trucks', 'International cuisine'],
      wifiQuality: 'Excellent',
      loadingBays: 25
    },
    city: 'Paris',
    ...
    countryCode: 'FR',
    industries: [industries[0]], // Technology
    description: 'Europe\'s biggest startup and tech event, connecting innovators, entrepreneurs, and tech leaders from around the world.',
  ...
  // ===================
  {
    ...
    venue: {
      ...
      totalSpace: 100000,
      hallCount: 12,
      facilities: ['Tech infrastructure', 'Innovation labs', 'Conference centers', 'Parking'],
      nearbyHotels: ['Aloft London ExCeL', 'Crowne Plaza London', 'Holiday Inn Express'],
      transportAccess: ['London City Airport', 'DLR', 'London Underground'],
      parkingSpaces: 3700,
      cateringOptions: ['British cuisine', 'International food', 'Tech networking venues'],
      wifiQuality: 'Excellent',
      loadingBays: 18
    },
    city: 'London',
    ...
    countryCode: 'GB',
    industries: [industries[0]], // Technology
    description: 'The UK\'s leading technology festival, bringing together the global tech community for innovation, networking, and business.',
  ...
  // ===================
  {
    ...
    venue: {
      ...
      totalSpace: 200000,
      hallCount: 14,
      facilities: ['Design studios', 'Exhibition halls', 'Conference centers', 'Parking'],
      nearbyHotels: ['Crowne Plaza Milan Malpensa', 'Four Points by Sheraton', 'AC Hotel Milano'],
      transportAccess: ['Malpensa Airport', 'Metro M1', 'Shuttle services'],
      parkingSpaces: 14000,
      cateringOptions: ['Italian cuisine', 'Design-themed dining', 'International food'],
      wifiQuality: 'Excellent',
      loadingBays: 32
    },
    city: 'Milan',
    ...
    description: 'The world\'s premier furniture and design fair, showcasing the latest in interior design, furniture, and home décor.',
    ...
    costs: {
      ...
      additionalCosts: [
        ...
        { item: 'Furniture display infrastructure', cost: 400, mandatory: false },
        { item: 'Lighting design setup', cost: 350, mandatory: false },
        { item: 'International design certification', cost: 200, mandatory: false }
      ]
    }
  }
...
export const tradeShowStats = {
  ...
  totalCountries: Array.from(new Set(tradeShows.map(show => show.country))).length,
  totalCities: Array.from(new Set(tradeShows.map(show => show.city))).length,
  totalIndustries: industries.length,
  totalExpectedVisitors: tradeShows.reduce((sum, show) => sum + show.expectedVisitors, 0),
  totalExpectedExhibitors: tradeShows.reduce((sum, show) => sum + show.expectedExhibitors, 0),
  averageShowSize: Math.round(tradeShows.reduce((sum, show) => sum + show.expectedVisitors, 0) / tradeShows.length),
  nextShow: tradeShows
...
export class TradeShowUtils {
  ...
  static getShowsBySignificance(significance: TradeShow['significance']): TradeShow[] {
  ...
  static generateSEOKeywords(show: TradeShow): string[] {
    return [
      ...
      ...show.industries.map(industry => `${industry.name.toLowerCase()} exhibition`),
