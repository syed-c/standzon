...
export default async function CountryPage({ params }: CountryPageProps) {
  ...
  try {
    ...
    const preloadedCountryData = await preloadQuery(api.locations.getCountryBySlug, { 
      countrySlug: country
    });
    ...
    const preloadedCitiesData = await preloadQuery(api.locations.getCitiesForCountry, { 
      countrySlug: country
    });

    // Preload builders data for this country
    const preloadedBuildersData = await preloadQuery(api.locations.getBuildersForCountry, { 
...
export async function generateStaticParams() {
  console.log('🚀 Generating static params for all countries from comprehensive global database...');
  ...
  try {
    ...
    console.log(`📄 Generated ${params.length} static country pages from comprehensive global database`);
