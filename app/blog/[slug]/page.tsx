    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <article className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
              ...
              [&_h2]:text-slate-900 [&_h2]:font-bold [&_h2]:text-3xl [&_h2]:mt-12 [&_h2]:mb-6 [&_h2]:leading-tight [&_h2]:tracking-tight
              [&_h3]:text-slate-900 [&_h3]:font-bold [&_h3]:text-2xl [&_h3]:mt-10 [&_h3]:mb-4
              [&_p]:text-slate-900 [&_p]:leading-relaxed [&_p]:mb-6 [&_p]:text-base
              [&_ul]:my-6 [&_li]:text-slate-900 [&_li]:leading-relaxed
