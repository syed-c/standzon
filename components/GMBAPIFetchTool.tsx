...
const countryCityMap: { [key: string]: string[] } = {
  ...
  'United Kingdom': ['London', 'Birmingham', 'Manchester', 'Liverpool', 'Edinburgh', 'Leeds', 'Bristol'],
  'France': ['Paris', 'Lyon', 'Strasbourg', 'Bordeaux', 'Lille'],
  'United Arab Emirates': ['Dubai', 'Abu Dhabi', 'Sharjah', 'Ras Al Khaimah', 'Fujairah', 'Ajman', 'Umm Al Quwain'],
  'Australia': ['Sydney', 'Melbourne', 'Brisbane', 'Perth', 'Gold Coast', 'Canberra'],
  'India': ['Mumbai', 'Bangalore', 'Hyderabad', 'Ahmedabad', 'Lucknow', 'Kanpur', 'Kolkata'],
  'China': ['Shanghai', 'Beijing', 'Guangzhou', 'Wuhan', 'Hangzhou', 'Nanjing', 'Tianjin', 'Xian'],
  'Japan': ['Tokyo', 'Osaka', 'Yokohama', 'Kobe', 'Chiba'],
  'Brazil': ['Brasília', 'Curitiba', 'Belo Horizonte', 'Salvador', 'Recife', 'Porto Alegre'],
  'Canada': ['Toronto', 'Vancouver', 'Montreal', 'Calgary', 'Ottawa'],
  'Mexico': ['Guadalajara', 'Monterrey', 'Cancun'],
  'Italy': ['Milan', 'Rome', 'Bologna', 'Florence', 'Venice', 'Verona'],
