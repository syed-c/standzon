...
export default function FinalAuditReport() {
  ...
  const testClaimButtons = async () => {
    try {
      ...
      const { ProfileClaimSystem } = await import('@/components/client/ProfileClaimSystem');
  ...
  const testClaimsPanel = async () => {
    try {
      const { default: AdminClaimsManager } = await import('@/components/client/AdminClaimsManager');
  ...
  const testBuilderStatusDisplay = async () => {
    try {
      const { default: BuilderCard } = await import('@/components/client/BuilderCard');
  ...
  const testCityPageIntegration = async () => {
    try {
      const { default: EnhancedCityPage } = await import('@/components/client/EnhancedCityPage');
