  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div
          className="absolute bottom-20 right-10 w-40 h-40 bg-rose-500/30 rounded-full blur-xl animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-24 h-24 bg-purple-500/20 rounded-full blur-xl animate-float"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
        ...
        >
          ...
          compare 500+ contractors in your city to find the perfect match. Save
          23% on average with free, instant quotes.
        </p>
