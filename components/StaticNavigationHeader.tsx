...
export default function StaticNavigationHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 w-full z-[100] bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm shadow-sm border-b border-gray-100/20 dark:border-slate-800">
        ...
        <div className="flex justify-between items-center h-16 w-full min-w-0">
          ...
          <div className="hidden lg:flex items-center justify-center flex-1 px-4 min-w-0">
            <div className="flex items-center gap-4 justify-center min-w-0 flex-nowrap">
              <Link href="/" className="px-2 py-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-pink-600 hover:bg-gray-100/50 whitespace-nowrap truncate max-w-[120px] flex-shrink-0">
                <span className="truncate">Home</span>
              </Link>
              <Link href="/builders" className="px-2 py-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-pink-600 hover:bg-gray-100/50 whitespace-nowrap truncate max-w-[120px] flex-shrink-0">
                <span className="truncate">Find Builders</span>
              </Link>
              <Link href="/exhibition-stands" className="px-2 py-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-pink-600 hover:bg-gray-100/50 whitespace-nowrap truncate max-w-[120px] flex-shrink-0">
          ...
          <div className="lg:hidden flex items-center space-x-2">
            ...
            <button
              className="p-2 rounded-lg transition-all duration-200 text-gray-700 dark:text-gray-200 hover:text-pink-600 hover:bg-gray-100/50 min-h-[36px] min-w-[36px] flex items-center justify-center"
