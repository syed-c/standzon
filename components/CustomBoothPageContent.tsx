...
const features = [
  {
    ...
    description: 'Every element designed to reflect your brand identity and values'
  },
  {
    icon: Lightbulb,
...
const process = [
  ...
  },
  {
    ...
    description: '3D concepts and layouts tailored to your space and objectives'
  },
  {
    step: '03',
  ...
  },
  {
    ...
    description: 'Expert construction and professional installation at your venue'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="bg-gradient-to-r from-purple-600 to-indigo-700 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Connect with expert designers who understand your industry and objectives
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/quote">
              <Button size="lg" className="bg-white text-purple-600 hover:bg-gray-100">
