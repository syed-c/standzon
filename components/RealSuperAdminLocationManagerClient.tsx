...
interface RealSuperAdminLocationManagerClientProps {
...
export function RealSuperAdminLocationManagerClient({ 
...
}: RealSuperAdminLocationManagerClientProps) {
  ...
  const [stats, setStats] = useState<LocationStats>({
    totalCountries: initialLocationStats?.totalCountries || 0,
    totalCities: initialLocationStats?.totalCities || 0,
    totalBuilders: initialLocationStats?.totalBuilders || 0,
    totalEvents: initialLocationStats?.totalEvents || 0,
    activeCountries: initialLocationStats?.activeCountries || 0,
    activeCities: initialLocationStats?.activeCities || 0,
    verifiedBuilders: initialLocationStats?.verifiedBuilders || 0,
    claimedBuilders: initialLocationStats?.claimedBuilders || 0
  });
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {filteredCities.slice(0, 20).map((city: City) => (
