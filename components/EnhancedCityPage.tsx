...
export function EnhancedCityPage({ 
  ...
  // Use preloaded data with proper hydration - handle both preloaded and direct data
  let cityData, builders;
  
  try {
    // Try to use preloaded data first
    cityData = usePreloadedQuery(preloadedCityData);
    builders = usePreloadedQuery(preloadedBuildersData) || [];
  } catch (error) {
    // Fallback to direct data if preloaded query fails
    console.log("🔄 Falling back to direct data access");
    cityData = (preloadedCityData as any)?._valueJSON ? 
      JSON.parse((preloadedCityData as any)._valueJSON) : 
      preloadedCityData;
    builders = (preloadedBuildersData as any)?._valueJSON ? 
      JSON.parse((preloadedBuildersData as any)._valueJSON) : 
      preloadedBuildersData || [];
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              ...
              <br />
              <span className="text-blue-200">in {cityData.cityName}, {cityData.country.countryName}</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Connect with {builderCount}+ verified exhibition stand builders in {cityData.cityName}. Get competitive quotes from local experts who understand your market.
            </p>
            
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100">
                Get Quotes from {cityData.cityName} Builders
              </Button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">
            Why Choose Local Builders in {cityData.cityName}?
          </h2>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  Understand local regulations, venue requirements, and cultural preferences specific to {cityData.cityName}.
                </p>
              </CardContent>
            </Card>
        ...
        <section className="mb-16">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900">
              Exhibition Stand Builders in {cityData.cityName}
            </h2>
          ...
          {!builders || builders.length === 0 ? (
            <Card className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                We're working on adding exhibition stand builders for {cityData.cityName}. 
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Get Free Quotes from {cityData.cityName} Builders
            </h2>
          ...
          <SimpleQuoteRequestForm 
            defaultCountry={cityData.country.countryName}
        ...
        <section className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">
            Need a Custom Exhibition Stand in {cityData.cityName}?
          </h2>
