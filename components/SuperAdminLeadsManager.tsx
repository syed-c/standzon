...
export function SuperAdminLeadsManager() {
  ...
  const leads = useQuery(api.admin.getAllLeads) || [];
  const quoteRequests = useQuery(api.admin.getAllQuoteRequests) || [];

  console.log('🎯 SuperAdminLeadsManager - Raw leads data:', leads);
  console.log('🎯 SuperAdminLeadsManager - Raw quote requests:', quoteRequests);
  ...
  console.log('🎯 SuperAdminLeadsManager - Safe leads:', safeLeads.length);
  console.log('🎯 SuperAdminLeadsManager - Safe quote requests:', safeQuoteRequests.length);
  ...
  console.log('🎯 SuperAdminLeadsManager - Combined leads:', allLeads.length, allLeads);
